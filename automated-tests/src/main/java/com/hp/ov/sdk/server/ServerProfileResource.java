...
import com.hp.ov.sdk.dto.servers.serverprofile.LogicalJbod;
...
public class ServerProfileResource extends BasicResource implements CreateResource, RemoveResource, UpdateResource {
    ...
    public ServerProfile builder() {
        ...
        if (resourceProperties.containsKey("sasLogicalJbodName")) {
            //Creates a SAS Logical JBOD
            LogicalJbod logicalJbod = new LogicalJbod();        
            logicalJbod.setName(resourceProperties.get("sasLogicalJbodName"));
            logicalJbod.setDeviceSlot(resourceProperties.get("deviceSlot"));
            logicalJbod.setDriveMaxSizeGB(Integer.valueOf(resourceProperties.get("driveMaxSizeGB")));
            logicalJbod.setDriveMinSizeGB(Integer.valueOf(resourceProperties.get("driveMinSizeGB")));
            logicalJbod.setDriveTechnology(resourceProperties.get("driveTechnology"));
            logicalJbod.setNumPhysicalDrives(Integer.valueOf(resourceProperties.get("numPhysicalDrives")));
            logicalJbod.setId(Integer.valueOf(resourceProperties.get("id")));  
            
            List<LogicalJbod> logicalJbodList = new ArrayList<>();
            logicalJbodList.add(logicalJbod);
            
            LocalStorage localStorage = new LocalStorage();
            localStorage.setSasLogicalJBODs(logicalJbodList);
                    
            sp.setLocalStorage(localStorage);
        } else {
    ...
    private void addVolume(ServerProfile sp) {
        ...
        if (hostOSType != null && volumeName != null) {
