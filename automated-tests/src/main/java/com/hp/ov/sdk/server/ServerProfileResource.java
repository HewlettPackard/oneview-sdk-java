...
import com.hp.ov.sdk.dto.servers.serverprofile.ConnectionStatus;
...
public class ServerProfileResource extends BasicResource implements CreateResource, RemoveResource, UpdateResource {
    ...
    private void addConnections(ServerProfile sp) {
        ...
        if (ethNetworks != null) {
            ...
            sp.setConnections(configConnections(fcNetwork, FunctionType.FibreChannel, "2500"));
        }
    ...
    private void addVolume(ServerProfile sp) {
        ...
        if (hostOSType != null && volumeName != null && fcNetworkName != null) {
            ...
            VolumeAttachment volumeAttachment = resourceDtoUtils.buildVolumeAttachment(volumeName, null, 1, true, null,
