...
public class SasLogicalInterconnectGroupBDDStep extends Background {

    @Given("^an instance of Sas Logical Interconnect Group$")
    public void an_instance_of_Sas_Logical_Interconnect_Group() throws Throwable {
        OneView.setResource(SasLogicalInterconnectGroupResource.getInstance());
    }
}
