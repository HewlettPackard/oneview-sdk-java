...
################################################################################
Feature: 
  In order to manage Storage Volume Template
  ...
  @create
  Scenario: Creation of a new Server Volume Template
  ...
  @get
  Scenario: Get all Storage Volume Template
  ...
  @update
  Scenario: Edit a Server Volume Template
    Given name "svt-bdd" for Resource
  ...
  @remove
  Scenario: Remove a Server Volume Template
