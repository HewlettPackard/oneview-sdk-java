...
public class SslPropertiesManager {
    ...
    public HttpSslProperties getSslProperties(final String keyStoreFile,
                                              final String trustStoreFile) {
       return getSslProperties(keyStoreFile, trustStoreFile,
    ...
    public void loadSslProperties(final HttpSslProperties httpSslProperties) {
        ...
        if (httpSslProperties.getKeyStore() != null &&
            !httpSslProperties.getKeyStore().trim().equals("")) {
           System.setProperty("javax.net.ssl.keyStore",
                              httpSslProperties.getKeyStore());
        }
        if (httpSslProperties.getTrustStore() != null &&
            !httpSslProperties.getTrustStore().trim().equals("")) {
           System.setProperty("javax.net.ssl.trustStore",
                              httpSslProperties.getTrustStore());
        }
        if (httpSslProperties.getTrustStorePassword() != null &&
            !httpSslProperties.getTrustStorePassword().trim().equals("")) {
           System.setProperty("javax.net.ssl.trustStorePassword",
                              httpSslProperties.getTrustStorePassword());
        }
        if (httpSslProperties.getKeyStorePassword() != null &&
            !httpSslProperties.getKeyStorePassword().trim().equals("")) {
           System.setProperty("javax.net.ssl.keyStorePassword",
                              httpSslProperties.getKeyStorePassword());
        }
        if (httpSslProperties.getTrustStoreType() != null &&
            !httpSslProperties.getTrustStoreType().trim().equals("")) {
           System.setProperty("javax.net.ssl.trustStoreType",
                              httpSslProperties.getTrustStoreType());
        }
        if (httpSslProperties.getKeyStoreType() != null &&
            !httpSslProperties.getKeyStoreType().trim().equals("")) {
           System.setProperty("javax.net.ssl.keyStoreType",
                              httpSslProperties.getKeyStoreType());
        }
