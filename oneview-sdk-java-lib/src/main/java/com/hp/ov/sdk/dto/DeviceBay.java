...
public class DeviceBay extends BaseModelResource {
    ...
    /**
     * @param availableForFullHeightProfile
     *            the availableForFullHeightProfile to set
     */
    public void setAvailableForFullHeightProfile(final Boolean availableForFullHeightProfile) {
    ...
    /**
     * @param availableForHalfHeightProfile
     *            the availableForHalfHeightProfile to set
     */
    public void setAvailableForHalfHeightProfile(final Boolean availableForHalfHeightProfile) {
    ...
    /**
     * @param coveredByDevice
     *            the coveredByDevice to set
     */
    ...
    /**
     * @param coveredByProfile
     *            the coveredByProfile to set
     */
