...
public class FcStatistics extends BaseModelResource {
    ...
    protected BigInteger fcRxFrameRate;
    protected BigInteger fcTxFrameRate;
    protected BigInteger fcRxByteRate;
    protected BigInteger fcTxByteRate;
    protected BigInteger fcTotalRxFrames;
    protected BigInteger fcTotalTxFrames;
    protected BigInteger fcAddressErrors;
    protected BigInteger fcClass2RxFrames;
    protected BigInteger fcClass2TxFrames;
    protected BigInteger fcClass3RxFrames;
    protected BigInteger fcClass3TxFrames;
    protected BigInteger fcClass3Discards;
    protected BigInteger fcInvalidCRC;
    protected BigInteger fcFramesTooLong;
    protected BigInteger fcFramesTruncated;
    protected BigInteger fcFRJTFrames;
    protected BigInteger fcFBSYFrames;
    protected BigInteger fcTotalRxBytes;
    protected BigInteger fcTotalTxBytes;
    protected BigInteger fcBBCreditFrameFailures;
    protected BigInteger fcBBCreditRRDYFailures;
    protected BigInteger fcLinkFailures;
    protected BigInteger fcRxLinkResets;
    protected BigInteger fcTxLinkResets;
    protected BigInteger fcNumberLinkResets;
    protected BigInteger fcLossOfSynchronization;
    protected BigInteger fcRxOfflineSequences;
    protected BigInteger fcTxOfflineSequences;
    protected BigInteger fcNumberOfflineSequences;
    protected BigInteger fcPrimitiveSeqProtocolErrors;
    protected BigInteger fcInvalidTxWords;
    protected BigInteger fcSmoothingOverflowErrors;
    protected BigInteger fcDecodeErrors;
    protected Map<String,String> extendedStatistics;
