...
public class StorageVolumeCollection extends BaseCollectionResource<StorageVolumeV2> {
    ...
    private final List<StorageVolumeV2> members = new ArrayList<StorageVolumeV2>();

    @Override
    public List<StorageVolumeV2> getMembers() {
        final List<StorageVolumeV2> _members = new ArrayList<StorageVolumeV2>();
    ...
    @Override
    public void setMembers(final List<StorageVolumeV2> _members) {
