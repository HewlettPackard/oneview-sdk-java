...
public class SwitchCollection extends BaseCollectionResource<Switch> {
    ...
    private static final long serialVersionUID = 2507004575310946369L;

    private final List<Switch> members = new ArrayList<>();
    ...
    @Override
    public void setMembers(final List<Switch> members) {
        if (members != null) {
            this.members.clear();
