...
public class AlertUpdate implements Serializable {
    ...
    /**
     * @param alertUrgency the alertUrgency to set
     */
    public void setAlertUrgency(AlertUrgency alertUrgency) {
