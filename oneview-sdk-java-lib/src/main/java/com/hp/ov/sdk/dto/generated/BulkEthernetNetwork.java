...
@JsonPropertyOrder({ "bandwidth", "smartLink", "namePrefix", "vlanIdRange", "privateNetwork", "purpose", "type", "jsonRequest" })
public class BulkEthernetNetwork implements Serializable {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(jsonRequest).append(bandwidth).append(smartLink).append(namePrefix).append(vlanIdRange)
    ...
    public boolean equals(final Object other) {
        ...
        return new EqualsBuilder().append(jsonRequest, rhs.jsonRequest).append(bandwidth, rhs.bandwidth)
                .append(smartLink, rhs.smartLink).append(namePrefix, rhs.namePrefix).append(vlanIdRange, rhs.vlanIdRange)
                .append(privateNetwork, rhs.privateNetwork).append(purpose, rhs.purpose).isEquals();
    }
