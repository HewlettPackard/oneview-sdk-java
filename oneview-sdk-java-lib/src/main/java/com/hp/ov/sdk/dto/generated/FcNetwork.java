...
@JsonPropertyOrder({ "fabricType", "connectionTemplateUri", "linkStabilityTime", "managedSanUri", "autoLoginRedistribution",
        "description", "status", "name", "state", "eTag", "created", "modified", "category", "uri", "type", "jsonRequest" })
