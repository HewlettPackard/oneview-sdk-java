...
@JsonPropertyOrder({ "serialNumber", "logicalInterconnectUri", "ports", "partNumber", "powerStatus", "ipAddressList",
        "snmpConfiguration", "enclosureUri", "productName", "interconnectTypeUri", "portCount", "igmpIdleTimeoutInterval",
        "enablePauseFloodProtection", "unsupportedCapabilities", "enclosureName", "firmwareVersion", "interconnectIP", "model",
        "interconnectLocation", "maxBandwidth", "subPortCount", "edgeVirtualBridgingAvailable", "enableIgmpSnooping",
        "networkLoopProtectionInterval", "enableNetworkLoopProtection", "enableFastMacCacheFailover", "roles", "description",
        "status", "name", "state", "eTag", "created", "modified", "category", "uri" })
