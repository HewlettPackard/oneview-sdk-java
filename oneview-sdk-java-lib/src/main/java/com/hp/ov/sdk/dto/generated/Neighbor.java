...
@JsonPropertyOrder({ "remoteChassisId", "remoteChassisIdType", "remoteMgmtAddress", "remoteMgmtAddressType",
        "remotePortDescription", "remotePortId", "remotePortIdType", "remoteSystemCapabilities", "remoteSystemDescription",
        "remoteSystemName", "remoteType" })
public class Neighbor implements Serializable {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(remoteChassisId).append(remoteChassisIdType).append(remoteMgmtAddress)
                .append(remoteMgmtAddressType).append(remotePortDescription).append(remotePortId).append(remotePortIdType)
                .append(remoteSystemCapabilities).append(remoteSystemDescription).append(remoteSystemName).append(remoteType)
                .toHashCode();
    }
    ...
    public boolean equals(final Object other) {
        ...
        final Neighbor rhs = ((Neighbor) other);
        return new EqualsBuilder().append(remoteChassisId, rhs.remoteChassisId)
                .append(remoteChassisIdType, rhs.remoteChassisIdType).append(remoteMgmtAddress, rhs.remoteMgmtAddress)
                .append(remoteMgmtAddressType, rhs.remoteMgmtAddressType).append(remotePortDescription, rhs.remotePortDescription)
                .append(remotePortId, rhs.remotePortId).append(remotePortIdType, rhs.remotePortIdType)
                .append(remoteSystemCapabilities, rhs.remoteSystemCapabilities)
                .append(remoteSystemDescription, rhs.remoteSystemDescription).append(remoteSystemName, rhs.remoteSystemName)
