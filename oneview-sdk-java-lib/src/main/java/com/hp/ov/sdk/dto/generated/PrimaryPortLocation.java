...
public class PrimaryPortLocation implements Serializable {
    ...
    public boolean equals(final Object other) {
        ...
        if ((other instanceof PrimaryPortLocation) == false) {
            return false;
        }
        final PrimaryPortLocation rhs = ((PrimaryPortLocation) other);
