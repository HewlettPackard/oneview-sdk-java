...
@JsonPropertyOrder({ "name", "state", "stateReason", "assetTag", "category", "created", "description", "eTag", "formFactor",
        "licensingIntent", "locationUri", "memoryMb", "model", "modified", "mpDnsName", "mpFirmwareVersion", "mpIpAddress",
        "mpModel", "partNumber", "portMap", "position", "powerLock", "powerState", "processorCoreCount", "processorCount",
        "processorSpeedMhz", "processorType", "refreshState", "romVersion", "serialNumber", "serverGroupUri",
        "serverHardwareTypeUri", "serverProfileUri", "shortModel", "signature", "status", "uri", "uuid", "virtualSerialNumber",
        "virtualUuid", "type" })
public class ServerHardware implements Serializable {
     ...
     */
    @JsonProperty("licensingIntent")
    public void setLicensingIntent(final ServerHardware.LicensingIntent licensingIntent) {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(name).append(state).append(stateReason).append(assetTag).append(category)
                .append(created).append(description).append(eTag).append(formFactor).append(licensingIntent).append(locationUri)
                .append(memoryMb).append(model).append(modified).append(mpDnsName).append(mpFirmwareVersion).append(mpIpAddress)
                .append(mpModel).append(partNumber).append(portMap).append(position).append(powerLock).append(powerState)
                .append(processorCoreCount).append(processorCount).append(processorSpeedMhz).append(processorType)
                .append(refreshState).append(romVersion).append(serialNumber).append(serverGroupUri).append(serverHardwareTypeUri)
                .append(serverProfileUri).append(shortModel).append(signature).append(status).append(uri).append(uuid)
                .append(virtualSerialNumber).append(virtualUuid).toHashCode();
    }
    ...
    public boolean equals(final Object other) {
        ...
        return new EqualsBuilder().append(name, rhs.name).append(state, rhs.state).append(stateReason, rhs.stateReason)
                .append(assetTag, rhs.assetTag).append(category, rhs.category).append(created, rhs.created)
                .append(description, rhs.description).append(eTag, rhs.eTag).append(formFactor, rhs.formFactor)
                .append(licensingIntent, rhs.licensingIntent).append(locationUri, rhs.locationUri).append(memoryMb, rhs.memoryMb)
                .append(model, rhs.model).append(modified, rhs.modified).append(mpDnsName, rhs.mpDnsName)
                .append(mpFirmwareVersion, rhs.mpFirmwareVersion).append(mpIpAddress, rhs.mpIpAddress).append(mpModel, rhs.mpModel)
                .append(partNumber, rhs.partNumber).append(portMap, rhs.portMap).append(position, rhs.position)
                .append(powerLock, rhs.powerLock).append(powerState, rhs.powerState)
                .append(processorCoreCount, rhs.processorCoreCount).append(processorCount, rhs.processorCount)
                .append(processorSpeedMhz, rhs.processorSpeedMhz).append(processorType, rhs.processorType)
                .append(refreshState, rhs.refreshState).append(romVersion, rhs.romVersion).append(serialNumber, rhs.serialNumber)
                .append(serverGroupUri, rhs.serverGroupUri).append(serverHardwareTypeUri, rhs.serverHardwareTypeUri)
                .append(serverProfileUri, rhs.serverProfileUri).append(shortModel, rhs.shortModel).append(signature, rhs.signature)
                .append(status, rhs.status).append(uri, rhs.uri).append(uuid, rhs.uuid)
                .append(virtualSerialNumber, rhs.virtualSerialNumber).append(virtualUuid, rhs.virtualUuid).isEquals();
    }

    @Generated("org.jsonschema2pojo")
    public static enum LicensingIntent {

        OneView("OneView"), OneViewNoiLO("OneViewNoiLO"), OneViewStandard("OneViewStandard"), None("None");
    ...
    public static enum PowerState {
        ...
        Unknown("Unknown"), On("On"), Off("Off"), PoweringOn("PoweringOn"), PoweringOff("PoweringOff"), Resetting("Resetting");
        private final String value;
