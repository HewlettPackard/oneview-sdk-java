...
public enum ILTError {
    ...
    IlpMiscabled,
    IlpNotConnected,
    IlpNotConnectedToExpectedICMKind,
    InterconnectLinkModuleNotSupportedForSingleEnclosureTopology,
    InterconnectPoweredOff,
    InterconnectsNotInSameSideOfBaySet,
    InvalidInterconnectKind,
    MixedInterconnectTypeInSameBaySet,
    moreThanOneflexFabric40GbEModuleAtOneSideofBaySet,
    NeighbourInterconnectPoweredOff,
    noflexFabric40GbEModuleAtSideA,
    NonHPECableInserted,
    UnsupportedInterconnectInSameBaySet;
