...
public class DriveEnclosureFirmware implements Serializable {

    private static final long serialVersionUID = 3295152958896429407L;

    private String desiredFw;
    private Integer enclosureBayNo;
    private String enclosureName;
    private String enclosureUri;
    private String installedFw;
    private List<IoAdapterFirmware> ioAdapters = new ArrayList<>();
    ...
    /**
     * @return the enclosureBayNo
     */
    public Integer getEnclosureBayNo() {
        return enclosureBayNo;
    }

    /**
     * @param enclosureBayNo the enclosureBayNo to set
     */
    public void setEnclosureBayNo(Integer enclosureBayNo) {
        this.enclosureBayNo = enclosureBayNo;
    }
     ...
     */
    public List<IoAdapterFirmware> getIoAdapters() {
        return ioAdapters;
    }
     ...
     */
    public void setIoAdapters(List<IoAdapterFirmware> ioAdapters) {
