...
public enum SDKErrorEnum implements SDKErrorKey {
    ...
    fail("FAIL"), invalidArgument("INVALID_ARGUMENT"), invalidUrl("INVALID_URL"), fileNotFound("FILE_NOTFOUND"), internalError(
            ...
            "BAD_REQUEST"), tasksError("TASKS_ERROR"), applicanceNotReachable("APPLIANCE_NOT_REACHABLE"), apiMismatchError(
            "API_VERSION_MISMATCH"), invalidOperationException("INVALID_OPERATION_EXCEPTION");
