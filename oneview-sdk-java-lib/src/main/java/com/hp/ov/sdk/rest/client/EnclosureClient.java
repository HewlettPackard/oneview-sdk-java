...
public interface EnclosureClient {
     ...
     */
    public TaskResourceV2 createEnclosure(final RestParams params, final AddEnclosureV2 addEnclosureDto, final boolean aSync,
     ...
     * can be used to update the OA firmware or the OA, logical interconnect,
