...
@Api(UplinkSetClient.UPLINK_SETS_URI)
public interface UplinkSetClient extends
        SearchableResource<UplinkSet>,
        CreatableResource<UplinkSet>,
        UpdatableResource<UplinkSet>,
        DeletableResource {

    String UPLINK_SETS_URI = "/rest/uplink-sets";
