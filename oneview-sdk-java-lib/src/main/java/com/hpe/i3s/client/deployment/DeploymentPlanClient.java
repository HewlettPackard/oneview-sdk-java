...
@Api(DeploymentPlanClient.DEPLOYMENT_PLAN_URI)
public interface DeploymentPlanClient extends SearchableResource<DeploymentPlan> {

    String DEPLOYMENT_PLAN_URI = "/rest/deployment-plans";
     ...
     *
     * @return {@link DeploymentPlan} object containing the result of this request.
     */
    @Endpoint(method = HttpMethod.POST)
    DeploymentPlan create(@BodyParam DeploymentPlan resource);
    ...
    DeploymentPlan update(@PathParam("resourceId") String resourceId, @BodyParam DeploymentPlan resource);
