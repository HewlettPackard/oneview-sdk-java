...
public class BuildStep implements Serializable {
    ...
    /**
     * @return the planScriptUri
     */
    public String getPlanScriptUri() {
        return planScriptUri;
    }

    /**
     * @param planScriptUri the planScriptUri to set
     */
    public void setPlanScriptUri(String planScriptUri) {
        this.planScriptUri = planScriptUri;
    }
