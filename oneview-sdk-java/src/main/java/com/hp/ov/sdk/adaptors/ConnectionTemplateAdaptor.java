        ...
        BaseAdaptor<ConnectionTemplate, Object>
{
    ...
    public ConnectionTemplate buildDto(final Object source)
    {
        ...
        final ConnectionTemplate connectionTemplateDto = converter.convertJsonToObject(util
    ...
    public ConnectionTemplateCollection buildCollectionDto(final Object source)
    {
        ...
        // convert json Object to DTO, replace quotes and back slash in the file
        final ConnectionTemplateCollection connectionTemplateCollectionDto = converter.convertJsonToObject(util
