        ...
        BaseAdaptor<InterconnectTypes, Object>
{
    ...
    public InterconnectTypes buildDto(final Object source)
    {
        ...
        final InterconnectTypes interconnectTypeDto = converter.convertJsonToObject(util
    ...
    public InterconnectTypeCollectionV2 buildCollectionDto(final Object source)
    {
        ...
        // convert json Object to DTO, replace quotes and back slash in the file
        final InterconnectTypeCollectionV2 interconnectTypeCollectionDto = converter.convertJsonToObject(util
