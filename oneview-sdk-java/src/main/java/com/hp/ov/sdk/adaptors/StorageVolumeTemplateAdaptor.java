        ...
        BaseAdaptor<StorageVolumeTemplate, Object>
{
    ...
    public StorageVolumeTemplate buildDto(final Object source)
    {
        ...
        final StorageVolumeTemplate storageVolumeTemplateDto = converter.convertJsonToObject(util
    ...
    public StorageVolumeTemplateCollection buildCollectionDto(final Object source)
    {
        ...
        // convert json Object to DTO, replace quotes and back slash in the file
        final StorageVolumeTemplateCollection storageVolumeTemplateCollectionDto = converter.convertJsonToObject(util
