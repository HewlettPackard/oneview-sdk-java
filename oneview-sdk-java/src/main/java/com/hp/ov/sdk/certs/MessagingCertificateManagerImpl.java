        ...
        MessagingCertificateManager
{
            ...
            final RestParams params)
    {
        ...
        final String tempKeyData = clientCert.getBase64SSLKeyData()
        ...
        final String tempCertData = clientCert.getBase64SSLCertData()
                .replace("-----BEGIN CERTIFICATE-----", "")
                .replace("-----END CERTIFICATE-----", "")
                .replaceAll(" ", "\\\n");
        final String tempCertDataUpdated = "-----BEGIN CERTIFICATE-----"
    ...
    @Override
    public String generateRabbitMqClientCert(final RestParams params,
            final RabbitMqClientCert rabbitMqClientCertDto, final boolean aSync,
