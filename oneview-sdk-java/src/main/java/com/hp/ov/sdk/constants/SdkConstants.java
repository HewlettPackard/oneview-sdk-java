...
public class SdkConstants
{
    ...
    public static final String LOGICAL_INTERCONNECT_GROUPS = LOGICAL_INTERCONNECT_GROUP
            + "s";
    ...
    public static final String LOGICAL_INTERCONNECTS = LOGICAL_INTERCONNECT
            + "s";
    ...
    public static final String STORAGE_VOLUME_TEMPLATES = STORAGE_VOLUME_TEMPLATE
            + "s";
