...
public class NetworkSetCollection extends BaseCollectionResource<NetworkSets>
{
    ...
    private final List<NetworkSets> members = new ArrayList<NetworkSets>();

    @Override
    public List<NetworkSets> getMembers()
    {
        final List<NetworkSets> _members = new ArrayList<NetworkSets>();
    ...
    @Override
    public void setMembers(final List<NetworkSets> _members)
    {
        this.members.clear();
