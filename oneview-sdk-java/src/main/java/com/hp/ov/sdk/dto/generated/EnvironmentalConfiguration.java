...
@JsonPropertyOrder({
        "powerHistorySupported", "thermalHistorySupported",
...
public class EnvironmentalConfiguration
{
    ...
    public void setUtilizationHistorySupported(
            final Boolean utilizationHistorySupported)
    {
    ...
    public void setHistorySampleIntervalSeconds(
            final Integer historySampleIntervalSeconds)
    {
    ...
    public void setPowerCapType(
            final EnvironmentalConfiguration.PowerCapType powerCapType)
    {
    ...
    public void setLicenseRequirement(
            final EnvironmentalConfiguration.LicenseRequirement licenseRequirement)
    {
    ...
    public static enum LicenseRequirement
    {
        ...
        public static EnvironmentalConfiguration.LicenseRequirement fromValue(
                final String value)
        {
            final EnvironmentalConfiguration.LicenseRequirement constant = constants
                    .get(value);
            if (constant == null)
            {
    ...
    public static enum PowerCapType
    {
        ...
        public static EnvironmentalConfiguration.PowerCapType fromValue(
                final String value)
        {
            final EnvironmentalConfiguration.PowerCapType constant = constants
                    .get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
