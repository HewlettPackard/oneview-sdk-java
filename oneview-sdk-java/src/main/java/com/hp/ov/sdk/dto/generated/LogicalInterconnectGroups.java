...
public class LogicalInterconnectGroups implements Serializable
{
    ...
    public void setStackingMode(
            final LogicalInterconnectGroups.StackingMode stackingMode)
    {
    ...
    public void setStackingHealth(
            final LogicalInterconnectGroups.StackingHealth stackingHealth)
    {
    ...
    public void setInterconnectMapTemplate(
            final InterconnectMapTemplate interconnectMapTemplate)
    {
    ...
    public static enum StackingHealth
    {
        ...
        public static LogicalInterconnectGroups.StackingHealth fromValue(
                final String value)
        {
            final LogicalInterconnectGroups.StackingHealth constant = constants
                    .get(value);
            if (constant == null)
            {
    ...
    public static enum StackingMode
    {
        ...
        public static LogicalInterconnectGroups.StackingMode fromValue(
                final String value)
        {
            final LogicalInterconnectGroups.StackingMode constant = constants
                    .get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
