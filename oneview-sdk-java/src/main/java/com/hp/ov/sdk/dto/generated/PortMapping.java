...
public class PortMapping implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(midplanePort)
                .append(interconnectBay).toHashCode();
    }
    ...
    public boolean equals(final Object other)
    {
        ...
        return new EqualsBuilder().append(midplanePort, rhs.midplanePort)
                .append(interconnectBay, rhs.interconnectBay).isEquals();
    }
