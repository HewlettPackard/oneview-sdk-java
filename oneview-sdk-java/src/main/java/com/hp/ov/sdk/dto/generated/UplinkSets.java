...
public class UplinkSets implements Serializable
{
    ...
    public void setManualLoginRedistributionState(
            final UplinkSets.ManualLoginRedistributionState manualLoginRedistributionState)
    {
    ...
    public void setEthernetNetworkType(
            final UplinkSets.EthernetNetworkType ethernetNetworkType)
    {
    ...
    public static enum ManualLoginRedistributionState
    {
        ...
        public static UplinkSets.ManualLoginRedistributionState fromValue(
                final String value)
        {
            final UplinkSets.ManualLoginRedistributionState constant = constants
                    .get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
