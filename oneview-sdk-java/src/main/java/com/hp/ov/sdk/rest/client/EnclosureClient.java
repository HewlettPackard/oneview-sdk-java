...
public interface EnclosureClient
{
     ...
     * This can be used to update the OA firmware or the OA, logical
     * interconnect,
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 updateEnclosureFwBaseline(
            final RestParams param,
            final String resourceId,
    ...
    /**
     * This methods aids in updating the environmental configuration of the
     * enclosure resourceId.
     * 
     * @param param
     *        The RestParams is a structure containing the connection
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 updateRefreshState(
            final RestParams param,
            final String resourceId,
