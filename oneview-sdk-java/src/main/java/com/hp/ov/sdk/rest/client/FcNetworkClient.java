...
public interface FcNetworkClient
{
     ...
     */
    public FcNetwork getFcNetwork(final RestParams params,
     ...
     * @return fcNetworkDto, which is a object containing the FcNetwork details.
     */
    public FcNetwork getFcNetworkByName(final RestParams params,
            final String name);
    ...
    public TaskResourceV2 createFcNetwork(final RestParams params,
            final FcNetwork fcNetworkDto, final boolean aSync,
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 updateFcNetwork(final RestParams params,
            final String resourceId, final FcNetwork fcNetworkDto,
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 deleteFcNetwork(final RestParams params,
