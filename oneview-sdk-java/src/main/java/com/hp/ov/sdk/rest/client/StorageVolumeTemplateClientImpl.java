...
@Component
public class StorageVolumeTemplateClientImpl implements
        StorageVolumeTemplateClient
{

    private static final Logger logger = LoggerFactory
            .getLogger(StorageVolumeTemplateClientImpl.class);
    ...
    @Override
    public StorageVolumeTemplate getStorageVolumeTemplate(final RestParams params,
            final String resourceId)
    {
        ...
        params.setUrl(sdkUtils.createRestUrl(params.getHostname(),
                ResourceUris.STORAGE_VOLUME_TEMPLATE_URI, resourceId));

        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("StorageVolumeTemplateClientImpl : getStorageVolumeTemplate : response from OV :"
                + returnObj);
        ...
        logger.debug("StorageVolumeTemplateClientImpl : getStorageVolumeTemplate : Name :"
                + storageVolumeTemplateDto.getName());
    ...
    @Override
    public StorageVolumeTemplateCollection getAllStorageVolumeTemplates(
            final RestParams params)
    {
        ...
        // call rest client
        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("StorageVolumeTemplateClientImpl : getAllStorageVolumeTemplates : response from OV :"
                + returnObj);
        ...
        final StorageVolumeTemplateCollection storageVolumeTemplateCollectionDto = adaptor
    ...
    @Override
    public StorageVolumeTemplate getStorageVolumeTemplateByName(
            final RestParams params, final String name)
    {
        ...
        params.setUrl(sdkUtils.createRestQueryUrl(params.getHostname(),
                ResourceUris.STORAGE_VOLUME_TEMPLATE_URI, query));

        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("StorageVolumeTemplateClientImpl : getStorageVolumeTemplateByName : response from OV :"
                + returnObj);
        if (null == returnObj || returnObj.equals(""))
        {
            throw new SDKNoResponseException(
        ...
        {
            storageVolumeTemplateDto = storageVolumeTemplateCollectionDto
                    .getMembers().get(0);
        }
        else
        {
        ...
        {
            logger.error("StorageVolumeTemplateClientImpl : getStorageVolumeTemplateByName : Not found for name :"
                    + name);
    ...
    public StorageVolumeTemplate createStorageVolumeTemplate(final RestParams params,
            StorageVolumeTemplate storageVolumeTemplateDto, final boolean aSync,
            final boolean useJsonRequest)
    {
        ...
        {
            throw new SDKInvalidArgumentException(SDKErrorEnum.invalidArgument,
                    null, null, null, SdkConstants.STORAGE_VOLUME_TEMPLATE,
                    null);
        }
        // set the additional params
        ...
        logger.debug("StorageVolumeTemplateClientImpl : createStorageVolumeTemplate : returnObj ="
                + returnObj);
    ...
    @Override
    public StorageVolumeTemplate updateStorageVolumeTemplate(final RestParams params,
            final String resourceId, StorageVolumeTemplate storageVolumeTemplateDto,
            final boolean useJsonRequest)
    {
        ...
        logger.debug("StorageVolumeTemplateClientImpl : updateStorageVolumeTemplate : returnObj ="
                + returnObj);
    ...
    @Override
    public String deleteStorageVolumeTemplate(final RestParams params,
            final String resourceId)
    {
        ...
        logger.debug("StorageVolumeTemplateClientImpl : deleteStorageVolumeTemplate : response from OV :"
                + returnObj);
        ...
        logger.debug("StorageVolumeTemplateClientImpl : deleteStorageVolumeTemplate : returnObj ="
                + returnObj);
    ...
    @Override
    public ConnectableStorageVolumeTemplateCollection getConnectableVolumeTemplates(
            final RestParams params)
    {
