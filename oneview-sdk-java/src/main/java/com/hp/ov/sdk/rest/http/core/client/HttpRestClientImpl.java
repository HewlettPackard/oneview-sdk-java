...
public class HttpRestClientImpl implements HttpRestClient
{
            ...
            final JSONObject jsonObject)
    {
        ...
        logger.debug("HttpRestClientImpl : sendRequestToHPOV : Rest params passed, params=: "
        ...
        try
        {
            ...
            final URL url_one = new URL(null, params.getUrl(),
            ...
            connection.setRequestProperty("X-API-Version",
                    StringUtil.convertIntToString(params.getApiVersion()));
            ...
            try
            {
                ...
                logger.debug("HttpRestClientImpl : sendRequestToHPOV : Response code = "
                        + responseCode);
        ...
        {
            throw new SDKNoSuchUrlException(SDKErrorEnum.invalidUrl, null,
                    null, null, SdkConstants.APPLIANCE, null);
        }
        catch (final IOException e)
        {
            ...
            {
                throw new SDKApplianceNotReachableException(
                        SDKErrorEnum.applicanceNotReachable, null, null, null,
                        SdkConstants.APPLIANCE, null);
            }
        }
