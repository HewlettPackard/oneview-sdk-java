...
public class FcNetworkAdaptor extends BaseAdaptor<FcNetwork, Object>
{
    ...
    @Override
    public FcNetwork buildDto(Object source)
    {
        // TODO - exceptions
        // convert json object to DTO, replace quotes and back slash in the file
        FcNetwork fcNetworkDto = converter.convertJsonToObject(util
                .replaceQuotesAndBackSlash(converter
                        .convertObjectToJsonString(source)), FcNetwork.class);
        return fcNetworkDto;
    }

    public FcNetworkCollection buildCollectionDto(Object source)
    {
        // TODO - exceptions
        ...
        // convert json object to DTO, replace quotes and back slash in the file
        FcNetworkCollection fcNetworkCollectionDto = converter.convertJsonToObject(util
