...
public class FirmwareDriverAdaptor extends BaseAdaptor<FwBaseline, Object>
{
    ...
    public FwBaseline buildDto(Object source)
    {
        // TODO - exceptions
        // convert json object to DTO, replace quotes and back slash in the file
        FwBaseline fwBaselineDto = converter.convertJsonToObject(util
                .replaceQuotesAndBackSlash(converter
                        .convertObjectToJsonString(source)), FwBaseline.class);
        return fwBaselineDto;
    }

    public FwBaselineCollection buildCollectionDto(Object source)
    {
        // TODO - exceptions
        ...
        // convert json object to DTO, replace quotes and back slash in the file
        FwBaselineCollection fwBaselineCollectionDto = converter.convertJsonToObject(util
