        ...
        BaseAdaptor<RabbitMqClientCert, Object>
{
    ...
    @Override
    public RabbitMqClientCert buildDto(Object source)
    {
        // TODO - exceptions
        // convert json object to DTO, replace quotes and back slash in the file
        RabbitMqClientCert rabbitMqClientCertDto = converter.convertJsonToObject(util
    ...
    public JSONObject buildJsonObjectFromDto(RabbitMqClientCert source)
    {
