...
public class ServerHardwareAdaptor extends BaseAdaptor<ServerHardware, Object>
{
    ...
    @Override
    public ServerHardware buildDto(Object source)
    {
        // TODO - exceptions
        // convert json object to DTO, replace quotes and back slash in the file
        ServerHardware serverHardwareDto = converter.convertJsonToObject(util
    ...
    public ServerHardwareCollection buildCollectionDto(Object source)
    {
        // TODO - exceptions
        ...
        // convert json Object to DTO, replace quotes and back slash in the file
        ServerHardwareCollection serverHardwareCollectionDto = converter.convertJsonToObject(util
