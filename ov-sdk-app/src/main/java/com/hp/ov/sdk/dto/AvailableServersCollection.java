...
public class AvailableServersCollection extends BaseCollectionResource<AvailableServers>
{
    ...
    private List<AvailableServers> members = new ArrayList<AvailableServers>();

    @Override
    public List<AvailableServers> getMembers()
    {
        List<AvailableServers> _members = new ArrayList<AvailableServers>();
    ...
    @Override
    public void setMembers(List<AvailableServers> _members)
    {
        this.members.clear();
