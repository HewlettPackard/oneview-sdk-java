...
public class ConnectionTemplateCollection extends BaseCollectionResource<ConnectionTemplate>
{
    ...
    private List<ConnectionTemplate> members = new ArrayList<ConnectionTemplate>();

    @Override
    public List<ConnectionTemplate> getMembers()
    {
        List<ConnectionTemplate> _members = new ArrayList<ConnectionTemplate>();
    ...
    @Override
    public void setMembers(List<ConnectionTemplate> _members)
    {
        this.members.clear();
