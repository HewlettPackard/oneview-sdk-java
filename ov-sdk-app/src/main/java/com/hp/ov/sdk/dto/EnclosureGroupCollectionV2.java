...
public class EnclosureGroupCollectionV2 extends BaseCollectionResource<EnclosureGroups>
{
    ...
    private List<EnclosureGroups> members = new ArrayList<EnclosureGroups>();

    @Override
    public List<EnclosureGroups> getMembers()
    {
        List<EnclosureGroups> _members = new ArrayList<EnclosureGroups>();
    ...
    @Override
    public void setMembers(List<EnclosureGroups> _members)
    {
        this.members.clear();
