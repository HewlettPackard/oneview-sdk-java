...
public class EnclosureV2 extends BaseModelResource
{
     ...
     */
    public void setDeviceBays(List<DeviceBay> deviceBays)
    {
     ...
     */
    public void setFanBays(List<Fan> fanBays)
    {
     ...
     */
    public void setInterconnectBays(List<InterconnectBayV2> interconnectBays)
    {
     ...
     */
    public void setPowerSupplyBays(List<PowerSupply> powerSupplyBays)
    {
