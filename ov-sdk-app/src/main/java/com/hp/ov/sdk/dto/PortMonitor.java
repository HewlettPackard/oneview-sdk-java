...
public class PortMonitor extends BaseModelResource
{
    ...
    /**
     * @param analyzerPort the analyzerPort to set
     */
    public void setAnalyzerPort(MonitorPortInfo analyzerPort)
    {
    ...
    /**
     * @param enablePortMonitor the enablePortMonitor to set
     */
    public void setEnablePortMonitor(Boolean enablePortMonitor)
    {
    ...
    /**
     * @param monitoredPorts the monitoredPorts to set
     */
    public void setMonitoredPorts(List<MonitorPortInfo> monitoredPorts)
    {
