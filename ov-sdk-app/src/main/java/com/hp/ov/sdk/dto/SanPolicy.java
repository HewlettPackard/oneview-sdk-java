...
public class SanPolicy implements Serializable
{
     ...
     *        The initiatorNameFormat
     */
    public void setInitiatorNameFormat(String initiatorNameFormat)
    {
     ...
     *        The targetGroupNameFormat
     */
    public void setTargetGroupNameFormat(String targetGroupNameFormat)
    {
     ...
     *        The targetNameFormat
     */
    public void setTargetNameFormat(String targetNameFormat)
    {
     ...
     *        The zoneNameFormat
     */
    public void setZoneNameFormat(String zoneNameFormat)
    {
     ...
     *        The zoningPolicy
     */
    public void setZoningPolicy(ZoningPolicy zoningPolicy)
    {
