...
public class ServerProfileCollection extends BaseCollectionResource<ServerProfile>
{
    ...
    private List<ServerProfile> members = new ArrayList<ServerProfile>();

    @Override
    public List<ServerProfile> getMembers()
    {
        List<ServerProfile> _members = new ArrayList<ServerProfile>();
    ...
    @Override
    public void setMembers(List<ServerProfile> _members)
    {
        this.members.clear();
