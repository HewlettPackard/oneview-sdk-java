...
public class StoragePoolCollection extends BaseCollectionResource<StoragePool>
{
    ...
    private List<StoragePool> members = new ArrayList<StoragePool>();

    @Override
    public List<StoragePool> getMembers()
    {
        List<StoragePool> _members = new ArrayList<StoragePool>();
    ...
    @Override
    public void setMembers(List<StoragePool> _members)
    {
