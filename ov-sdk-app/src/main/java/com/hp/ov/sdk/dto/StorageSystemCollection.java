...
public class StorageSystemCollection extends BaseCollectionResource<StorageSystemV2>
{
    ...
    private List<StorageSystemV2> members = new ArrayList<StorageSystemV2>();

    @Override
    public List<StorageSystemV2> getMembers()
    {
        List<StorageSystemV2> _members = new ArrayList<StorageSystemV2>();
    ...
    @Override
    public void setMembers(List<StorageSystemV2> _members)
    {
