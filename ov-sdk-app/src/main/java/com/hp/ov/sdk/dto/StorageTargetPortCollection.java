...
public class StorageTargetPortCollection extends BaseCollectionResource<StorageTargetPort>
{
    ...
    private List<StorageTargetPort> members = new ArrayList<StorageTargetPort>();

    @Override
    public List<StorageTargetPort> getMembers()
    {
        List<StorageTargetPort> _members = new ArrayList<StorageTargetPort>();
    ...
    @Override
    public void setMembers(List<StorageTargetPort> _members)
    {
