...
public class StorageVolumeCollection extends BaseCollectionResource<StorageVolumeV2>
{
    ...
    private List<StorageVolumeV2> members = new ArrayList<StorageVolumeV2>();

    @Override
    public List<StorageVolumeV2> getMembers()
    {
        List<StorageVolumeV2> _members = new ArrayList<StorageVolumeV2>();
    ...
    @Override
    public void setMembers(List<StorageVolumeV2> _members)
    {
