...
public class TrapDestination implements Serializable
{
    ...
    /**
     * @param enetTrapCategories the enetTrapCategories to set
     */
    public void setEnetTrapCategories(List<EnetTrapCategory> enetTrapCategories)
    {
    ...
    /**
     * @param fcTrapCategories the fcTrapCategories to set
     */
    public void setFcTrapCategories(List<FcTrapCategory> fcTrapCategories)
    {
    ...
    /**
     * @param trapDestination the trapDestination to set
     */
    ...
    /**
     * @param trapFormat the trapFormat to set
     */
    public void setTrapFormat(SnmpVersion trapFormat)
    {
    ...
    /**
     * @param trapSeverities the trapSeverities to set
     */
    ...
    /**
     * @param vcmTrapCategories the vcmTrapCategories to set
     */
    public void setVcmTrapCategories(List<VcmTrapCategory> vcmTrapCategories)
    {
