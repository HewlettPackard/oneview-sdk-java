...
public class UplinkSetCollectionV2 extends BaseCollectionResource<UplinkSets>
{
    ...
    private List<UplinkSets> members = new ArrayList<UplinkSets>();

    @Override
    public List<UplinkSets> getMembers()
    {
        List<UplinkSets> _members = new ArrayList<UplinkSets>();
    ...
    @Override
    public void setMembers(List<UplinkSets> _members)
    {
        this.members.clear();
