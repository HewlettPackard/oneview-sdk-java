...
@JsonPropertyOrder({
        "serverHardwareUri", "enclosureGroupUri",
        "serverHardwareTypeUri", "powerState", "name"
})
public class AvailableServers implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(serverHardwareUri)
                .append(enclosureGroupUri).append(serverHardwareTypeUri)
    ...
    public boolean equals(Object other)
    {
        ...
        AvailableServers rhs = ((AvailableServers) other);
        return new EqualsBuilder()
                ...
                .append(powerState, rhs.powerState).append(name, rhs.name)
                .isEquals();
    }
