...
public class BootMode implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(manageMode).append(pxeBootPolicy)
                .append(mode).toHashCode();
    }
    ...
    public boolean equals(Object other)
    {
        ...
        BootMode rhs = ((BootMode) other);
        return new EqualsBuilder().append(manageMode, rhs.manageMode)
                .append(pxeBootPolicy, rhs.pxeBootPolicy)
