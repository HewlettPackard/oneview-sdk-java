...
public class BulkEthernetNetwork implements Serializable
{
     ...
     */
    @JsonProperty("vlanIdRange")
    public void setVlanIdRange(String vlanIdRange)
    {
     ...
     */
    @JsonProperty("purpose")
    public void setPurpose(BulkEthernetNetwork.Purpose purpose)
    {
    ...
    public boolean equals(Object other)
    {
        ...
        BulkEthernetNetwork rhs = ((BulkEthernetNetwork) other);
    ...
    public static enum Purpose
    {
        ...
        static
        {
            for (BulkEthernetNetwork.Purpose c : values())
            {
        ...
        @JsonCreator
        public static BulkEthernetNetwork.Purpose fromValue(String value)
        {
            BulkEthernetNetwork.Purpose constant = constants.get(value);
            if (constant == null)
            {
