...
@JsonPropertyOrder({
        "deviceName", "location", "oaSlotNumber", "physicalPorts",
        "slotNumber"
})
public class DeviceSlot implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(deviceName).append(location)
                .append(oaSlotNumber).append(physicalPorts).append(slotNumber)
                .toHashCode();
    }
    ...
    public boolean equals(Object other)
    {
        ...
        DeviceSlot rhs = ((DeviceSlot) other);
        return new EqualsBuilder().append(deviceName, rhs.deviceName)
                .append(location, rhs.location)
                .append(oaSlotNumber, rhs.oaSlotNumber)
                .append(physicalPorts, rhs.physicalPorts)
                .append(slotNumber, rhs.slotNumber).isEquals();
    }
    ...
    public static enum Location
    {
        ...
        static
        {
            for (DeviceSlot.Location c : values())
            {
        ...
        {
            DeviceSlot.Location constant = constants.get(value);
            if (constant == null)
            {
