...
@JsonPropertyOrder({
        "uri", "uuid", "name", "serialNumber", "partNumber",
        "assetTag", "enclosureType", "enclosureGroupUri", "rackName",
        "deviceBayCount", "deviceBays", "interconnectBayCount",
        "interconnectBays", "powerSupplyBayCount", "powerSupplyBays",
        "fanBayCount", "fanBays", "oa", "oaBayCount", "activeOaPreferredIP",
        "standbyOaPreferredIP", "isFwManaged", "fwBaselineName",
        "fwBaselineUri", "vcmMode", "vcmUrl", "vcmDomainName", "vcmDomainId",
        "category", "description", "created", "modified", "eTag",
        "licensingIntent", "state", "stateReason", "refreshState", "status",
...
public class Enclosures implements Serializable
{
     ...
     */
    @JsonProperty("licensingIntent")
    public void setLicensingIntent(Enclosures.LicensingIntent licensingIntent)
    {
     ...
     */
    @JsonProperty("refreshState")
    public void setRefreshState(Enclosures.RefreshState refreshState)
    {
     ...
     */
    @JsonProperty("reconfigurationState")
    public void setReconfigurationState(
            Enclosures.ReconfigurationState reconfigurationState)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(uri).append(uuid).append(name)
                .append(serialNumber).append(partNumber).append(assetTag)
                .append(enclosureType).append(enclosureGroupUri)
                .append(rackName).append(deviceBayCount).append(deviceBays)
                .append(interconnectBayCount).append(interconnectBays)
                .append(powerSupplyBayCount).append(powerSupplyBays)
                .append(fanBayCount).append(fanBays).append(oa)
                .append(oaBayCount).append(activeOaPreferredIP)
                .append(standbyOaPreferredIP).append(isFwManaged)
                .append(fwBaselineName).append(fwBaselineUri).append(vcmMode)
                .append(vcmUrl).append(vcmDomainName).append(vcmDomainId)
                .append(category).append(description).append(created)
                .append(modified).append(eTag).append(licensingIntent)
                .append(state).append(stateReason).append(refreshState)
                .append(status).append(consistentWithGroup)
                .append(reconfigurationState).toHashCode();
    }
    ...
    public boolean equals(Object other)
    {
        ...
        Enclosures rhs = ((Enclosures) other);
        return new EqualsBuilder().append(uri, rhs.uri).append(uuid, rhs.uuid)
                .append(name, rhs.name).append(serialNumber, rhs.serialNumber)
                ...
                .append(fanBays, rhs.fanBays).append(oa, rhs.oa)
                ...
                .append(vcmMode, rhs.vcmMode).append(vcmUrl, rhs.vcmUrl)
    ...
    public static enum LicensingIntent
    {
        ...
        static
        {
            for (Enclosures.LicensingIntent c : values())
            {
                constants.put(c.value, c);
            }
        }

        private LicensingIntent(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Enclosures.LicensingIntent fromValue(String value)
        {
            Enclosures.LicensingIntent constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum ReconfigurationState
    {
        ...
        static
        {
            for (Enclosures.ReconfigurationState c : values())
            {
                constants.put(c.value, c);
            }
        }

        private ReconfigurationState(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Enclosures.ReconfigurationState fromValue(String value)
        {
            Enclosures.ReconfigurationState constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum RefreshState
    {
        ...
        static
        {
            for (Enclosures.RefreshState c : values())
            {
                constants.put(c.value, c);
            }
        }

        private RefreshState(String value)
        {
            this.value = value;
        }
        ...
        {
            Enclosures.RefreshState constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
