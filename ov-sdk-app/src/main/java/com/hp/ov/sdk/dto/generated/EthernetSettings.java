...
@JsonPropertyOrder({
        "interconnectType", "enableIgmpSnooping",
        "igmpIdleTimeoutInterval", "enableFastMacCacheFailover",
        "macRefreshInterval", "enableNetworkLoopProtection",
        "enablePauseFloodProtection", "dependentResourceUri", "name", "id",
        "description", "status", "state", "eTag", "created", "modified",
        "category", "uri", "type"
})
public class EthernetSettings implements Serializable
{
    ...
    private EthernetSettings.InterconnectType interconnectType = EthernetSettings.InterconnectType
            .fromValue("Ethernet");
     ...
     */
    @JsonProperty("interconnectType")
    public void setInterconnectType(
            EthernetSettings.InterconnectType interconnectType)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(interconnectType)
                .append(enableIgmpSnooping).append(igmpIdleTimeoutInterval)
                .append(enableFastMacCacheFailover).append(macRefreshInterval)
                .append(enableNetworkLoopProtection)
                .append(enablePauseFloodProtection)
                .append(dependentResourceUri).append(name).append(id)
                .append(description).append(status).append(state).append(eTag)
    ...
    public boolean equals(Object other)
    {
        ...
        EthernetSettings rhs = ((EthernetSettings) other);
        return new EqualsBuilder()
                ...
                .append(name, rhs.name).append(id, rhs.id)
    ...
    public static enum InterconnectType
    {
        ...
        static
        {
            for (EthernetSettings.InterconnectType c : values())
            {
                constants.put(c.value, c);
            }
        }

        private InterconnectType(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static EthernetSettings.InterconnectType fromValue(String value)
        {
            EthernetSettings.InterconnectType constant = constants.get(value);
            if (constant == null)
            {
