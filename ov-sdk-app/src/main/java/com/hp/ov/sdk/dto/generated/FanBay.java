...
public class FanBay implements Serializable
{
     ...
     */
    @JsonProperty("devicePresence")
    public void setDevicePresence(FanBay.DevicePresence devicePresence)
    {
     ...
     */
    @JsonProperty("status")
    public void setStatus(FanBay.Status status)
    {
        this.status = status;
    }
     ...
     */
    @JsonProperty("state")
    public void setState(FanBay.State state)
    {
        this.state = state;
    }
    ...
    public static enum DevicePresence
    {
        ...
        static
        {
            for (FanBay.DevicePresence c : values())
            {
        ...
        @JsonCreator
        public static FanBay.DevicePresence fromValue(String value)
        {
            FanBay.DevicePresence constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum State
    {
        ...
        {
            FanBay.State constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum Status
    {
        ...
        {
            FanBay.Status constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
