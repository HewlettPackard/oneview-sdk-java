...
public class FcNetwork implements Serializable
{
    ...
    public static enum FabricType
    {
        ...
        static
        {
            for (FcNetwork.FabricType c : values())
            {
                constants.put(c.value, c);
            }
        }

        private FabricType(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static FcNetwork.FabricType fromValue(String value)
        {
            FcNetwork.FabricType constant = constants.get(value);
            if (constant == null)
            {
