...
@JsonPropertyOrder({
        "principleInterconnectName", "wwpn", "wwnn", "logins",
        "opOnline", "opOnlineReason", "loginsCount", "fcfMac",
...
public class FcPortProperties implements Serializable
{
     ...
     */
    @JsonProperty("principleInterconnectNameList")
    public void setPrincipleInterconnectNameList(
            List<String> principleInterconnectNameList)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(principleInterconnectName)
                .append(wwpn).append(wwnn).append(logins).append(opOnline)
                .append(opOnlineReason).append(loginsCount).append(fcfMac)
    ...
    public boolean equals(Object other)
    {
        ...
        FcPortProperties rhs = ((FcPortProperties) other);
        return new EqualsBuilder()
                .append(principleInterconnectName,
                        rhs.principleInterconnectName)
                .append(wwpn, rhs.wwpn)
                .append(wwnn, rhs.wwnn)
                .append(logins, rhs.logins)
                .append(opOnline, rhs.opOnline)
                .append(opOnlineReason, rhs.opOnlineReason)
                .append(loginsCount, rhs.loginsCount)
                .append(fcfMac, rhs.fcfMac)
                .append(principleInterconnectNameList,
                        rhs.principleInterconnectNameList)
                .append(neighborInterconnectName, rhs.neighborInterconnectName)
                .isEquals();
    }
