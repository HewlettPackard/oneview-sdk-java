...
public class InterconnectMapTemplate implements Serializable
{
     ...
     */
    @JsonProperty("interconnectMapEntryTemplates")
    public void setInterconnectMapEntryTemplates(
            List<InterconnectMapEntryTemplate> interconnectMapEntryTemplates)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(interconnectMapEntryTemplates)
                .toHashCode();
    }
    ...
    public boolean equals(Object other)
    {
        ...
        InterconnectMapTemplate rhs = ((InterconnectMapTemplate) other);
        return new EqualsBuilder().append(interconnectMapEntryTemplates,
                rhs.interconnectMapEntryTemplates).isEquals();
    }
