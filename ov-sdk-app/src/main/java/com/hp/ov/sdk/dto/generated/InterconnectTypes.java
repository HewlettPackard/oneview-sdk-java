...
@JsonPropertyOrder({
        "partNumber", "minimumFirmwareVersion",
        "maximumFirmwareVersion", "downlinkCapabilities", "portInfos",
        "unsupportedCapabilities", "downlinkCount", "description", "status",
...
public class InterconnectTypes implements Serializable
{
     ...
     */
    @JsonProperty("maximumFirmwareVersion")
    public void setMaximumFirmwareVersion(String maximumFirmwareVersion)
    {
     ...
     */
    @JsonProperty("downlinkCapabilities")
    public void setDownlinkCapabilities(List<String> downlinkCapabilities)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(type).append(partNumber)
                .append(minimumFirmwareVersion).append(maximumFirmwareVersion)
                .append(downlinkCapabilities).append(portInfos)
                .append(unsupportedCapabilities).append(downlinkCount)
    ...
    public boolean equals(Object other)
    {
        ...
        InterconnectTypes rhs = ((InterconnectTypes) other);
        return new EqualsBuilder().append(type, rhs.type)
                ...
                .append(maximumFirmwareVersion, rhs.maximumFirmwareVersion)
                .append(downlinkCapabilities, rhs.downlinkCapabilities)
                .append(portInfos, rhs.portInfos)
                .append(unsupportedCapabilities, rhs.unsupportedCapabilities)
                .append(downlinkCount, rhs.downlinkCount)
