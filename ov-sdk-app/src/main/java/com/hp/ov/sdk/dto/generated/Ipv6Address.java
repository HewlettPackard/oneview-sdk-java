...
public class Ipv6Address implements Serializable
{
    ...
    public boolean equals(Object other)
    {
        ...
        Ipv6Address rhs = ((Ipv6Address) other);
    ...
    public static enum Type
    {
        ...
        @JsonCreator
        public static Ipv6Address.Type fromValue(String value)
        {
            Ipv6Address.Type constant = constants.get(value);
            if (constant == null)
            {
