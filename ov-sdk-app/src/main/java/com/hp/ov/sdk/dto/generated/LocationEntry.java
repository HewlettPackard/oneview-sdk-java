...
public class LocationEntry implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(relativeValue).append(value)
    ...
    public boolean equals(Object other)
    {
        ...
        LocationEntry rhs = ((LocationEntry) other);
        return new EqualsBuilder().append(relativeValue, rhs.relativeValue)
                .append(value, rhs.value).append(type, rhs.type).isEquals();
    }
    ...
    public static enum Type
    {
        ...
        static
        {
            for (LocationEntry.Type c : values())
            {
        ...
        @JsonCreator
        public static LocationEntry.Type fromValue(String value)
        {
            LocationEntry.Type constant = constants.get(value);
            if (constant == null)
            {
