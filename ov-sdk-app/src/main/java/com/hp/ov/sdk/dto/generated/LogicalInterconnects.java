...
public class LogicalInterconnects implements Serializable
{
    ...
    public void setStackingHealth(
            LogicalInterconnects.StackingHealth stackingHealth)
    {
    ...
    public boolean equals(Object other)
    {
        ...
        LogicalInterconnects rhs = ((LogicalInterconnects) other);
    ...
    public static enum StackingHealth
    {
        ...
        static
        {
            for (LogicalInterconnects.StackingHealth c : values())
            {
        ...
        {
            LogicalInterconnects.StackingHealth constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum Compliance
    {
        ...
        static
        {
            for (LogicalInterconnects.Compliance c : values())
            {
                constants.put(c.value, c);
            }
        }

        private Compliance(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static LogicalInterconnects.Compliance fromValue(String value)
        {
            LogicalInterconnects.Compliance constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum StackingMode
    {
        ...
        static
        {
            for (LogicalInterconnects.StackingMode c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        {
            LogicalInterconnects.StackingMode constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
