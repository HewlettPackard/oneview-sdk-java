...
public class LogicalPortConfigInfo implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(logicalLocation)
    ...
    public boolean equals(Object other)
    {
        ...
        LogicalPortConfigInfo rhs = ((LogicalPortConfigInfo) other);
        return new EqualsBuilder().append(logicalLocation, rhs.logicalLocation)
                .append(desiredSpeed, rhs.desiredSpeed).isEquals();
    }
    ...
    public static enum DesiredSpeed
    {
        ...
        static
        {
            for (LogicalPortConfigInfo.DesiredSpeed c : values())
            {
                constants.put(c.value, c);
            }
        }

        private DesiredSpeed(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static LogicalPortConfigInfo.DesiredSpeed fromValue(String value)
        {
            LogicalPortConfigInfo.DesiredSpeed constant = constants.get(value);
            if (constant == null)
            {
