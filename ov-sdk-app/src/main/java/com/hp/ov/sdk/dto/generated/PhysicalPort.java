...
public class PhysicalPort implements Serializable
{
    ...
    public boolean equals(Object other)
    {
        ...
        PhysicalPort rhs = ((PhysicalPort) other);
    ...
    public static enum Type
    {
        ...
        static
        {
            for (PhysicalPort.Type c : values())
            {
        ...
        @JsonCreator
        public static PhysicalPort.Type fromValue(String value)
        {
            PhysicalPort.Type constant = constants.get(value);
            if (constant == null)
            {
