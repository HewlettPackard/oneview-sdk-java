...
@JsonPropertyOrder({
        "portName", "portStatus", "portHealthStatus",
        "portStatusReason", "enabled", "interconnectName", "fcPortProperties",
        "bayNumber", "portType", "lagId", "associatedUplinkSetUri", "portId",
        "portMonitorConfigInfo", "capability", "pairedPortName", "subports",
        "connectorType", "neighbor", "configPortTypes", "portTypeExtended",
        "operationalSpeed", "description", "status", "name", "state", "eTag",
        "created", "modified", "category", "uri"
})
public class Port implements Serializable
{
     ...
     */
    @JsonProperty("portStatus")
    public void setPortStatus(Port.PortStatus portStatus)
    {
     ...
     */
    @JsonProperty("portHealthStatus")
    public void setPortHealthStatus(Port.PortHealthStatus portHealthStatus)
    {
     ...
     */
    @JsonProperty("portStatusReason")
    public void setPortStatusReason(Port.PortStatusReason portStatusReason)
    {
     ...
     */
    @JsonProperty("portMonitorConfigInfo")
    public void setPortMonitorConfigInfo(
            Port.PortMonitorConfigInfo portMonitorConfigInfo)
    {
     ...
     */
    @JsonProperty("configPortTypes")
    public void setConfigPortTypes(List<String> configPortTypes)
    {
     ...
     */
    @JsonProperty("portTypeExtended")
    public void setPortTypeExtended(Port.PortTypeExtended portTypeExtended)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(portName).append(portStatus)
                .append(portHealthStatus).append(portStatusReason)
                .append(enabled).append(interconnectName)
                .append(fcPortProperties).append(bayNumber).append(portType)
                .append(lagId).append(associatedUplinkSetUri).append(portId)
                .append(portMonitorConfigInfo).append(capability)
                .append(pairedPortName).append(subports).append(connectorType)
                .append(neighbor).append(configPortTypes)
                .append(portTypeExtended).append(operationalSpeed)
    ...
    public boolean equals(Object other)
    {
        ...
        Port rhs = ((Port) other);
        return new EqualsBuilder().append(portName, rhs.portName)
                .append(portStatus, rhs.portStatus)
                .append(portHealthStatus, rhs.portHealthStatus)
                .append(portStatusReason, rhs.portStatusReason)
                .append(enabled, rhs.enabled)
                .append(interconnectName, rhs.interconnectName)
                .append(fcPortProperties, rhs.fcPortProperties)
                .append(bayNumber, rhs.bayNumber)
                .append(portType, rhs.portType).append(lagId, rhs.lagId)
                .append(associatedUplinkSetUri, rhs.associatedUplinkSetUri)
                .append(portId, rhs.portId)
                .append(portMonitorConfigInfo, rhs.portMonitorConfigInfo)
                .append(capability, rhs.capability)
                .append(pairedPortName, rhs.pairedPortName)
                .append(subports, rhs.subports)
                .append(connectorType, rhs.connectorType)
                .append(neighbor, rhs.neighbor)
                .append(configPortTypes, rhs.configPortTypes)
                .append(portTypeExtended, rhs.portTypeExtended)
                .append(operationalSpeed, rhs.operationalSpeed)
    ...
    public static enum PortHealthStatus
    {
        ...
        static
        {
            for (Port.PortHealthStatus c : values())
            {
                constants.put(c.value, c);
            }
        }

        private PortHealthStatus(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Port.PortHealthStatus fromValue(String value)
        {
            Port.PortHealthStatus constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum PortMonitorConfigInfo
    {
        ...
        MonitoredToServer ("MonitoredToServer"),
        MonitoredFromServer (
                "MonitoredFromServer"),
        MonitoredBoth ("MonitoredBoth"),
        AnalyzerPort (
                "AnalyzerPort");
        private final String value;
        ...
        static
        {
            for (Port.PortMonitorConfigInfo c : values())
            {
                constants.put(c.value, c);
            }
        }

        private PortMonitorConfigInfo(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Port.PortMonitorConfigInfo fromValue(String value)
        {
            Port.PortMonitorConfigInfo constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum PortStatus
    {
        ...
        static
        {
            for (Port.PortStatus c : values())
            {
                constants.put(c.value, c);
            }
        }

        private PortStatus(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Port.PortStatus fromValue(String value)
        {
            Port.PortStatus constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum PortStatusReason
    {
        ...
        LoopDetected (
                "LoopDetected"),
        PauseFloodDetected ("PauseFloodDetected"),
        AdminDisabled (
                "AdminDisabled"),
        EkeyMismatch ("EkeyMismatch"),
        Unpopulated (
                "Unpopulated"),
        ModuleUnrecognized ("ModuleUnrecognized"),
        FailedValidation (
                "FailedValidation"),
        ModuleUnsupported ("ModuleUnsupported"),
        ModuleIncompatible (
                "ModuleIncompatible"),
        SmartLink ("SmartLink"),
        SmartLinkButNoDCC (
                "SmartLinkButNoDCC"),
        OkUncertified ("OkUncertified"),
        OkNonHP (
                "OkNonHP"),
        ...
        static
        {
            for (Port.PortStatusReason c : values())
            {
                constants.put(c.value, c);
            }
        }

        private PortStatusReason(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Port.PortStatusReason fromValue(String value)
        {
            Port.PortStatusReason constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum PortType
    {
        ...
        @JsonCreator
        public static Port.PortType fromValue(String value)
        {
            Port.PortType constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum PortTypeExtended
    {
        ...
        static
        {
            for (Port.PortTypeExtended c : values())
            {
                constants.put(c.value, c);
            }
        }

        private PortTypeExtended(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Port.PortTypeExtended fromValue(String value)
        {
            Port.PortTypeExtended constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
