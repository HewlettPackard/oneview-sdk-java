...
public class PortConfigInfo implements Serializable
{
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(desiredSpeed).append(portUri)
    ...
    public boolean equals(Object other)
    {
        ...
        PortConfigInfo rhs = ((PortConfigInfo) other);
        return new EqualsBuilder().append(desiredSpeed, rhs.desiredSpeed)
                .append(portUri, rhs.portUri).append(location, rhs.location)
                .isEquals();
    }
    ...
    public static enum DesiredSpeed
    {
        ...
        static
        {
            for (PortConfigInfo.DesiredSpeed c : values())
            {
        ...
        {
            PortConfigInfo.DesiredSpeed constant = constants.get(value);
            if (constant == null)
            {
