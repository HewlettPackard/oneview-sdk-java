...
@JsonPropertyOrder({
        "portName", "portNumber", "pairedPortName",
        "portCapability", "downlinkCapable", "uplinkCapable"
})
public class PortInfo implements Serializable
{
     ...
     */
    @JsonProperty("portCapability")
    public void setPortCapability(List<String> portCapability)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(portName).append(portNumber)
                .append(pairedPortName).append(portCapability)
    ...
    public boolean equals(Object other)
    {
        ...
        return new EqualsBuilder().append(portName, rhs.portName)
                .append(portNumber, rhs.portNumber)
                .append(pairedPortName, rhs.pairedPortName)
                .append(portCapability, rhs.portCapability)
                .append(downlinkCapable, rhs.downlinkCapable)
                .append(uplinkCapable, rhs.uplinkCapable).isEquals();
    }
