...
@JsonPropertyOrder({
        "bayNumber", "devicePresence", "status", "model",
        "serialNumber", "partNumber", "sparePartNumber"
})
public class PowerSupplyBay implements Serializable
{
     ...
     */
    @JsonProperty("devicePresence")
    public void setDevicePresence(PowerSupplyBay.DevicePresence devicePresence)
    {
     ...
     */
    @JsonProperty("status")
    public void setStatus(PowerSupplyBay.Status status)
    {
        this.status = status;
    }
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(bayNumber).append(devicePresence)
                .append(status).append(model).append(serialNumber)
    ...
    public static enum DevicePresence
    {
        ...
        static
        {
            for (PowerSupplyBay.DevicePresence c : values())
            {
                constants.put(c.value, c);
            }
        }

        private DevicePresence(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static PowerSupplyBay.DevicePresence fromValue(String value)
        {
            PowerSupplyBay.DevicePresence constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum Status
    {
        ...
        static
        {
            for (PowerSupplyBay.Status c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static PowerSupplyBay.Status fromValue(String value)
        {
            PowerSupplyBay.Status constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
