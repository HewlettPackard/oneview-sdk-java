...
public class ServerHardware implements Serializable
{
    ...
    public void setLicensingIntent(
            ServerHardware.LicensingIntent licensingIntent)
    {
     ...
     */
    @JsonProperty("powerState")
    public void setPowerState(ServerHardware.PowerState powerState)
    {
     ...
     */
    @JsonProperty("refreshState")
    public void setRefreshState(ServerHardware.RefreshState refreshState)
    {
    ...
    public boolean equals(Object other)
    {
        ...
        ServerHardware rhs = ((ServerHardware) other);
    ...
    public static enum LicensingIntent
    {
        ...
        static
        {
            for (ServerHardware.LicensingIntent c : values())
            {
        ...
        @JsonCreator
        public static ServerHardware.LicensingIntent fromValue(String value)
        {
            ServerHardware.LicensingIntent constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum PowerState
    {
        ...
        static
        {
            for (ServerHardware.PowerState c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static ServerHardware.PowerState fromValue(String value)
        {
            ServerHardware.PowerState constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum RefreshState
    {
        ...
        static
        {
            for (ServerHardware.RefreshState c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static ServerHardware.RefreshState fromValue(String value)
        {
            ServerHardware.RefreshState constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
