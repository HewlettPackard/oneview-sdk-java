...
public class StoragePath implements Serializable
{
    ...
    public boolean equals(Object other)
    {
        ...
        StoragePath rhs = ((StoragePath) other);
    ...
    public static enum StorageTargetType
    {
        ...
        static
        {
            for (StoragePath.StorageTargetType c : values())
            {
        ...
        @JsonCreator
        public static StoragePath.StorageTargetType fromValue(String value)
        {
            StoragePath.StorageTargetType constant = constants.get(value);
            if (constant == null)
            {
