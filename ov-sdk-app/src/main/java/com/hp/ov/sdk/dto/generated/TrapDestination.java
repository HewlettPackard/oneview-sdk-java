...
@JsonPropertyOrder({
        "trapSeverities", "enetTrapCategories",
        "fcTrapCategories", "vcmTrapCategories", "trapFormat",
...
public class TrapDestination implements Serializable
{
    ...
    private TrapDestination.TrapFormat trapFormat = TrapDestination.TrapFormat
            .fromValue("SNMPv1");
     ...
     */
    @JsonProperty("trapSeverities")
    public void setTrapSeverities(List<String> trapSeverities)
    {
     ...
     */
    @JsonProperty("enetTrapCategories")
    public void setEnetTrapCategories(List<String> enetTrapCategories)
    {
     ...
     */
    @JsonProperty("fcTrapCategories")
    public void setFcTrapCategories(List<String> fcTrapCategories)
    {
     ...
     */
    @JsonProperty("vcmTrapCategories")
    public void setVcmTrapCategories(List<String> vcmTrapCategories)
    {
     ...
     */
    @JsonProperty("trapFormat")
    public void setTrapFormat(TrapDestination.TrapFormat trapFormat)
    {
     ...
     */
    @JsonProperty("trapDestination")
    public void setTrapDestination(String trapDestination)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(trapSeverities)
                .append(enetTrapCategories).append(fcTrapCategories)
                .append(vcmTrapCategories).append(trapFormat)
                .append(trapDestination).append(communityString).toHashCode();
    }
    ...
    public boolean equals(Object other)
    {
        ...
        TrapDestination rhs = ((TrapDestination) other);
        return new EqualsBuilder().append(trapSeverities, rhs.trapSeverities)
    ...
    public static enum TrapFormat
    {
        ...
        static
        {
            for (TrapDestination.TrapFormat c : values())
            {
                constants.put(c.value, c);
            }
        }

        private TrapFormat(String value)
        {
            this.value = value;
        }
        ...
        @JsonCreator
        public static TrapDestination.TrapFormat fromValue(String value)
        {
            TrapDestination.TrapFormat constant = constants.get(value);
            if (constant == null)
            {
