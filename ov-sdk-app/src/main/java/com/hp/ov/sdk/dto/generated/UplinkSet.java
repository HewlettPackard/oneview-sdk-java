...
@JsonPropertyOrder({
        "mode", "networkUris", "reachability", "networkType",
        "logicalPortConfigInfos", "lacpTimer", "ethernetNetworkType",
        "primaryPort", "nativeNetworkUri", "name", "type"
})
public class UplinkSet implements Serializable
{
     ...
     */
    @JsonProperty("mode")
    public void setMode(UplinkSet.Mode mode)
    {
        this.mode = mode;
    }
     ...
     */
    @JsonProperty("reachability")
    public void setReachability(UplinkSet.Reachability reachability)
    {
     ...
     */
    @JsonProperty("networkType")
    public void setNetworkType(UplinkSet.NetworkType networkType)
    {
     ...
     */
    @JsonProperty("logicalPortConfigInfos")
    public void setLogicalPortConfigInfos(
            List<LogicalPortConfigInfo> logicalPortConfigInfos)
    {
     ...
     */
    @JsonProperty("lacpTimer")
    public void setLacpTimer(UplinkSet.LacpTimer lacpTimer)
    {
    ...
    public void setEthernetNetworkType(
            UplinkSet.EthernetNetworkType ethernetNetworkType)
    {
     ...
     */
    @JsonProperty("primaryPort")
    public void setPrimaryPort(PrimaryPort primaryPort)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(mode).append(networkUris)
                .append(reachability).append(networkType)
                .append(logicalPortConfigInfos).append(lacpTimer)
                .append(ethernetNetworkType).append(primaryPort)
    ...
    public static enum EthernetNetworkType
    {
        ...
        static
        {
            for (UplinkSet.EthernetNetworkType c : values())
            {
        ...
        @JsonCreator
        public static UplinkSet.EthernetNetworkType fromValue(String value)
        {
            UplinkSet.EthernetNetworkType constant = constants.get(value);
            if (constant == null)
            {
    ...
    public static enum LacpTimer
    {
        ...
        static
        {
            for (UplinkSet.LacpTimer c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        {
            UplinkSet.LacpTimer constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum Mode
    {
        ...
        @JsonCreator
        public static UplinkSet.Mode fromValue(String value)
        {
            UplinkSet.Mode constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum NetworkType
    {
        ...
        static
        {
            for (UplinkSet.NetworkType c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static UplinkSet.NetworkType fromValue(String value)
        {
            UplinkSet.NetworkType constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
    ...
    public static enum Reachability
    {
        ...
        static
        {
            for (UplinkSet.Reachability c : values())
            {
                constants.put(c.value, c);
            }
        }
        ...
        {
            UplinkSet.Reachability constant = constants.get(value);
            if (constant == null)
            {
                throw new IllegalArgumentException(value);
            }
