...
@JsonPropertyOrder({
        "storagePaths", "permanent", "state", "lun", "volumeUri",
        "lunType", "volumeStorageSystemUri", "volumeName",
        "volumeProvisionedCapacityBytes", "volumeProvisionType",
        "volumeStoragePoolUri", "volumeShareable", "volumeDescription",
        "status", "id"
})
public class VolumeAttachment implements Serializable
{
     ...
     */
    @JsonProperty("state")
    public void setState(VolumeAttachment.State state)
    {
        this.state = state;
    }
     ...
     */
    @JsonProperty("volumeProvisionedCapacityBytes")
    public void setVolumeProvisionedCapacityBytes(
            String volumeProvisionedCapacityBytes)
    {
    ...
    public int hashCode()
    {
        return new HashCodeBuilder().append(storagePaths).append(permanent)
                .append(state).append(lun).append(volumeUri).append(lunType)
                .append(volumeStorageSystemUri).append(volumeName)
                .append(volumeProvisionedCapacityBytes)
                .append(volumeProvisionType).append(volumeStoragePoolUri)
                .append(volumeShareable).append(volumeDescription)
    ...
    public boolean equals(Object other)
    {
        ...
        return new EqualsBuilder()
                .append(storagePaths, rhs.storagePaths)
                .append(permanent, rhs.permanent)
                .append(state, rhs.state)
                .append(lun, rhs.lun)
                .append(volumeUri, rhs.volumeUri)
                .append(lunType, rhs.lunType)
                .append(volumeStorageSystemUri, rhs.volumeStorageSystemUri)
                .append(volumeName, rhs.volumeName)
                .append(volumeProvisionedCapacityBytes,
                        rhs.volumeProvisionedCapacityBytes)
                .append(volumeProvisionType, rhs.volumeProvisionType)
                .append(volumeStoragePoolUri, rhs.volumeStoragePoolUri)
                .append(volumeShareable, rhs.volumeShareable)
                .append(volumeDescription, rhs.volumeDescription)
    ...
    public static enum State
    {
        ...
        UserDeleted (
                "UserDeleted"),
        VolumeCreateFailed ("VolumeCreateFailed"),
        VolumeCreating (
                "VolumeCreating"),
        ...
        static
        {
            for (VolumeAttachment.State c : values())
            {
        ...
        {
            VolumeAttachment.State constant = constants.get(value);
            if (constant == null)
            {
