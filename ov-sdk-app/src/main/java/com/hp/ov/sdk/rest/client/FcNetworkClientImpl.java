...
public class FcNetworkClientImpl implements FcNetworkClient
{
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(FcNetworkClientImpl.class);
    ...
    @Override
    public FcNetworkCollection getFcNetworkByFilter(final RestParams params,
            final Integer start, final Integer count)
    {
        ...
        params.setUrl(sdkUtils.createRestQueryUrl(params.getHostname(),
                ResourceUris.FC_NETWORK_URI, query));

        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("FcNetworkClientImpl : getFcNetworkByFilter : response from OV :"
                + returnObj);
        if (null == returnObj || returnObj.equals(""))
        {
            throw new SDKNoResponseException(
                    SDKErrorEnum.noResponseFromAppliance, null, null, null,
                    SdkConstants.FC_NETWORKS, null);
        }
        // Call adaptor to convert to DTO

        final FcNetworkCollection fcNetworkCollectionDto = adaptor.buildCollectionDto(returnObj);

        logger.debug("FcNetworkClientImpl : getFcNetworkByFilter : count :"
                + fcNetworkCollectionDto.getCount());
    ...
    public FcNetworkCollection getAllFcNetworks(final RestParams params)
    {
        ...
        params.setType(HttpMethodType.GET);
        params.setUrl(sdkUtils.createRestUrl(params.getHostname(),
                ResourceUris.FC_NETWORK_URI));

        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("FcNetworkClientImpl : getAllFcNetworks : response from OV :"
                + returnObj);
        if (null == returnObj || returnObj.equals(""))
        {
            throw new SDKNoResponseException(
        ...
        logger.debug("FcNetworkClientImpl : getAllFcNetworks : count :"
                + fcNetworkCollectionDto.getCount());
    ...
    public FcNetwork getFcNetworkByName(final RestParams params, final String name)
    {
        ...
        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("FcNetworkClientImpl : getFcNetworkByName : response from OV :"
                + returnObj);
        if (null == returnObj || returnObj.equals(""))
        {
            throw new SDKNoResponseException(
        ...
        {
            logger.error("FcNetworkClientImpl : getFcNetworkByName : resource not Found for name :"
                + name);
    ...
    @Override
    public TaskResourceV2 createFcNetwork(final RestParams params,
            final FcNetwork fcNetworkDto, final boolean aSync, final boolean useJsonRequest)
    {
        ...
        {
            throw new SDKInvalidArgumentException(SDKErrorEnum.invalidArgument,
                    null, null, null, SdkConstants.FC_NETWORKS, null);
        }
        // set the additional params
        ...
        {
            final FcNetwork dto = adaptor.buildDto(fcNetworkDto
                    .getJsonRequest().getBody());
        ...
        logger.debug("FcNetworkClientImpl : createFcNetwork : returnObj ="
                + returnObj);
        logger.debug("FcNetworkClientImpl : createFcNetwork : taskResource ="
                + taskResourceV2);
    ...
    @Override
    public TaskResourceV2 updateFcNetwork(final RestParams params, final String resourceId,
            final FcNetwork fcNetworkDto, final boolean aSync, final boolean useJsonRequest)
    {
        ...
        logger.debug("FcNetworkClientImpl : updateFcNetwork : returnObj ="
                + returnObj);
        logger.debug("FcNetworkClientImpl : updateFcNetwork : taskResource ="
                + taskResourceV2);
    ...
    @Override
    public TaskResourceV2 deleteFcNetwork(final RestParams params, final String resourceId,
            final boolean aSync)
    {
        ...
        final String returnObj = restClient.sendRequestToHPOV(params, null);
        logger.debug("FcNetworkClientImpl : deleteFcNetwork : response from OV :"
                + returnObj);
        ...
        logger.debug("FcNetworkClientImpl : deleteFcNetwork : returnObj ="
                + returnObj);
        logger.debug("FcNetworkClientImpl : deleteFcNetwork : taskResource ="
                + taskResourceV2);
