...
public interface LogicalInterconnectGroupClient
{
     ...
     */
    public TaskResourceV2 createLogicalInterconnectGroup(
            final RestParams params,
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 updateLogicalInterconnectGroup(
            final RestParams params, final String resourceId,
            final List<UplinkSet> uplinkSetDto, final boolean aSync,
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 deleteLogicalInterconnectGroup(
            final RestParams params, final String resourceId,
            final boolean aSync);
    
    /**
     * The module aids in fetching the default interconnect settings details for the LIG
