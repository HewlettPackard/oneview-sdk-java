...
public interface NetworkSetClient
{
     ...
     *         details.
     */
    public NetworkSets getNetworkSets(final RestParams params,
     ...
     *         details.
     */
    public NetworkSets getNetworkSetsByName(final RestParams params,
            final String name);
    ...
    public TaskResourceV2 createNetworkSet(final RestParams params,
            final NetworkSets networkSet, final boolean aSync,
    ...
    public TaskResourceV2 updateNetworkSet(final RestParams params,
            final String resourceId, final NetworkSets networkSetDto,
