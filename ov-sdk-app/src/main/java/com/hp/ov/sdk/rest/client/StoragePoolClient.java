...
public interface StoragePoolClient
{
     ...
     *         details.
     */
    public StoragePool getStoragePool(final RestParams params,
     ...
     *         details.
     */
    public StoragePool getStoragePoolByName(final RestParams params,
            final String name);
    ...
    public String createStoragePool(final RestParams params,
            final AddStoragePool storagePoolDto, final boolean useJsonRequest);
     ...
     */
    public String updateStoragePool(final RestParams params,
            final String resourceId, final StoragePool storagePoolDto,
     ...
     */
    public String deleteStoragePool(final RestParams params,
            final String resourceId);
