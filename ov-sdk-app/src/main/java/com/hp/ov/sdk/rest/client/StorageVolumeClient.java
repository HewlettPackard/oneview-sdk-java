...
public interface StorageVolumeClient
{
     ...
     *         details.
     */
    public StorageVolumeV2 getStorageVolume(final RestParams params,
     ...
     *         details.
     */
    public StorageVolumeV2 getStorageVolumeByName(final RestParams params,
            final String name);
     ...
     */
    public String updateStorageVolume(final RestParams params,
            final String resourceId, final StorageVolumeV2 storageVolumeDto,
            final boolean useJsonRequest);
    ...
    /**
     * This method aids in fetching  the volumes that are connected on the specified networks 
     * based on the storage system port's expected network connectivity.
     * @param params
     * 			The RestParams is a structure containing the connection
     *        details.
     * @return attachableStorageVolumeCollection, volume object that are attached to storage system. 
     */
