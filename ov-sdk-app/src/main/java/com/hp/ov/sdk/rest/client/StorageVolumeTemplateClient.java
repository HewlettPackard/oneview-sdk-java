...
public interface StorageVolumeTemplateClient
{
     ...
     */
    public StorageVolumeTemplate getStorageVolumeTemplate(
     ...
     *         StorageVolumeTemplate details.
     */
    public StorageVolumeTemplate createStorageVolumeTemplate(
            final RestParams params,
            final StorageVolumeTemplate storageVolumeTemplateDto,
     ...
     *         StorageVolumeTemplate details.
     */
    public StorageVolumeTemplate updateStorageVolumeTemplate(
            final RestParams params, final String resourceId,
            final StorageVolumeTemplate storageVolumeTemplateDto,
    ...
    /**
     * This module aids in fetching the storage volume templates that are available on the 
     * specified networks based on the storage system port's expected network connectivity.
     *  If there are no storage volume templates that meets the specified connectivity criteria 
     *  an empty collection will be returned
     * @param params
     * 			The RestParams is a structure containing the connection
     *        details.
     * @return ConnectableStorageVolumeTemplateCollection, fetches the storage volume template on
     * specified networks based on the storage system port. 
     * 		
     */
