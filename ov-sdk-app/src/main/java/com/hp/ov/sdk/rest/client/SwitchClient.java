...
public interface SwitchClient {
     ...
     *        details.
	 * @return switchCollectionDto, which is a object containing the collection of 
     *        switch details.
	 */
	 ...
	 * @return switchDto, which is a object containing the switch
     *         details.
	 */
	 ...
	 * 			The RestParams is a structure containing the connection
     *        details.
	 * @param switchDto, which is a object containing the switch
     *         details.
	...
	/**
	 * This method aids in fetching the environmental configuration for the switch.
	 * @param params
	 * 			The RestParams is a structure containing the connection
     *        details.
	 * @param resourceId
	 * 			The resourceId for StorageVolume as seen in HP OneView.
	 * @return environmentConfiguration, contains the environment configuration for the switch.
	 */
