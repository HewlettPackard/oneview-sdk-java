...
public interface UplinkSetClient
{
     ...
     *         details.
     */
    public UplinkSets getUplinkSet(final RestParams params,
     ...
     */
    public TaskResourceV2 deleteUplinkSet(final RestParams params,
     ...
     * @return taskResource which returns the task status for the process
     */
    public TaskResourceV2 updateUplinkSet(final RestParams params,
            final String resourceId, final UplinkSets uplinkDto,
            final boolean aSync, final boolean useJsonRequest);

    /**
     * The module aids in fetching the UplinkSets details for the
     * specified UplinkSets name as specified in HP OneView.
     * 
     * @param params
     *        The RestParams is a structure containing the connection
     *        details.
     * @param uplinkSetName
     *        The resourceName is the UplinkSets name as seen in HP
     *        OneView.
     * @return uplinkSetsDto, which is a object containing the
     *         UplinkSets details.
     */
