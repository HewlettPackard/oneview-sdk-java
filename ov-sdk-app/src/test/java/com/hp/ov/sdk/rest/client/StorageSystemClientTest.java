  ...
  //TODO-expand the failure scenario to help user 
            ...
            IllegalAccessException
    {
        ...
        try
        {
            ...
            StorageSystemV2 updateStorageSystemDto = buildUpdateStorageSystemDto(storageSystemDto);
    ...
    {
        AddStorageSystemCredentials dto = new AddStorageSystemCredentials();
            ...
            StorageSystemV2 storageSystemDto)
    {
        ...
        List<StorageTargetPortV2> tempStorageTargetPort = new ArrayList<StorageTargetPortV2>();
        ...
        for (int i = 0; i < storageSystemDto.getUnmanagedPorts().size(); i++)
        {
            ...
            {
                StorageTargetPortV2 managed_one = new StorageTargetPortV2();
            ...
            {
                StorageTargetPortV2 managed_two = new StorageTargetPortV2();
